...
import { isTypedRequestOptionsWithPayload, isTypedRequestOptionsWithPayloadWithAdditionalAndAccept } from "./TypedRequestOptions";
...
describe("isTypedRequestOptionsWithPayloadWithAdditionalAndAccept type predicate", function () {
  describe("Has Payload, Content Type Handler, Accept Header, And Additional Headers", function () {
    ...
    it("should be true", function () {
      expect(isTypedRequestOptionsWithPayloadWithAdditionalAndAccept(options)).to.be.true;
    });
  });
  describe("Has Payload, Content Type Handler, And Accept Header, No Additional Headers", function () {
    ...
    it("should be false", function () {
      expect(isTypedRequestOptionsWithPayloadWithAdditionalAndAccept(options)).to.be.false;
    });
  });
